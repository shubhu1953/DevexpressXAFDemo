...
namespace DevexpressDemo.Module {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/clsDevExpressExpressAppModuleBasetopic.aspx.
    public sealed partial class DevexpressDemoModule : ModuleBase {
        static DevexpressDemoModule() {
            ...
            // Do not use this code in a production environment to avoid data loss.
             #if DEBUG
             Database.SetInitializer(new DropCreateDatabaseIfModelChanges<DevexpressDemoDbContext>());
             #endif 
        }
        public DevexpressDemoModule() {
            InitializeComponent();
        }
